...
type ForecastRepo struct {
	GetSpotForecastFn       func(ctx context.Context, country, region, spot string, partitionSources []string) ([]*model.Forecast, error)
...
func (m *ForecastRepo) GetSpotForecast(ctx context.Context, country, region, spot string, partitionSources []string) ([]*model.Forecast, error) {
	if m.GetSpotForecastFn != nil {
		return m.GetSpotForecastFn(ctx, country, region, spot, partitionSources)
	}
